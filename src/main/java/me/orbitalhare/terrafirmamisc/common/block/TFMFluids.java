...
public class TFMFluids {
    public static final DeferredRegister<Fluid> FLUIDS = DeferredRegister.create(ForgeRegistries.FLUIDS, MODID);

    public static final Map<TFMMetal, FluidRegistryObject<ForgeFlowingFluid>> METALS = Helpers.mapOfKeys(TFMMetal.class, metal -> register(
            "metal/" + metal.getSerializedName(),
            properties -> properties
                    .block(TFMBlocks.METAL_FLUIDS.get(metal))
                    .bucket(TFMItems.METAL_FLUID_BUCKETS.get(metal))
                    .explosionResistance(100),
            lavaLike()
                    .descriptionId("fluid.terrafirmamisc.metal." + metal.getSerializedName())
